 ...
 * 5. create payment intent post on server side, and return client secret,
 *  install stripe on the server side and get client secret,
 *  make sure used the payment method types: ['card'].
 * 6. from client side get the client secret and save it,
 * 7. use  confirm card payment and pass user  information,
